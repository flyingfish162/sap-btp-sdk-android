...
You can add custom logic to the app to decide on the action to take, such as displaying the new Office Furniture category by modifing the `showMessageDialog` method in the class `FCMPushCallbackListener`.
