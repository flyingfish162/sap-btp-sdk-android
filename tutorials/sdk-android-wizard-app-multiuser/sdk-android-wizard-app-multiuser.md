...
- You completed [Offline-Enable Your Android Application](https://developers.sap.com/tutorials/sdk-android-wizard-app-offline.html).
...
- To enable multi-user for an application developed using Flows component, you only need follow the instructions at [Try Out the SAP BTP SDK Wizard for Android](https://developers.sap.com/tutorials/sdk-android-wizard-app.html) to create a new application using the SAP BTP SDK Wizard for Android and check **Enable Multiple Users** for the **Multiple Users** on the **Project Features** tab. Or you can follow **Step 2** and **3** to enable multi-user mode for online and offline, respectively.
